...
export const CONSTRAINTS: Record<string, FieldConstraints> = {
  ...
  appearance: { minLength: 1, maxLength: 2000, required: true, },
  ...
  default_outfit: { minLength: 1, maxLength: 64, required: true, },
  outfits: { maxItems: 20, required: true, },
  outfit_id: { minLength: 1, maxLength: 64, required: true, },
  outfit_name: { minLength: 1, maxLength: 64, required: true, },
  outfit_descriptor: { minLength: 1, maxLength: 2000, required: true, },
