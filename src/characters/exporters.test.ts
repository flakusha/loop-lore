...
const testCharacter: CanonicalCharacter = {
  ...
  appearance: "Tall figure with sharp features and dark hair",
  default_outfit: "travel-gear",
  outfits: [
    { id: "travel-gear", name: "Travel Gear", descriptor: "Sturdy traveling clothes and boots", },
  ],
...
describe("round-trip: CCv2", () => {
  test("CCv2 → canonical → CCv2 preserves data", () => {
    ...
    const canonical: CanonicalCharacter = {
      ...
      default_outfit: parsed.data.default_outfit ?? "",
      outfits: parsed.data.outfits ?? [],
