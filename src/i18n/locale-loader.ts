 ...
 * @returns flattened translations for the locale (cached after first call). Returns empty map on read failure.
 */
 ...
 * @returns the nested `TranslationMap`, or `undefined` if not loaded and load failed.
 */
