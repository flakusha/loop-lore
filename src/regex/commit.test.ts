...
import { CONVENTIONAL_COMMIT, SEMVER, RELEASE_BRANCH } from "./commit";
...
describe("commit regex", () => {
  describe("CONVENTIONAL_COMMIT", () => {
    it.each([
      ...
      ["fix(auth): resolve login bug", { type: "fix", scope: "auth", breaking: undefined, subject: "resolve login bug" }],
      ["refactor!: breaking change", { type: "refactor", scope: undefined, breaking: "!", subject: "breaking change" }],
