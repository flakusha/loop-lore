 ...
 *
 * Extraction point for `insertGeneratedEntity` so both the (deprecated)
 ...
 * confirmed.
 *
 * The lore-row builder is split into {@link ./create-entity-lore}; this file
 * keeps the per-kind entity insert switch and orchestration only.
 */
