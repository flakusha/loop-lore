...
export const txt2img: WorkflowTemplate = {
  ...
  parameters: [
    { name: "prompt", type: "string", label: "Prompt", description: "Text description of the image to generate", default: "", required: true },
    { name: "negative_prompt", type: "string", label: "Negative Prompt", description: "Things to avoid in the generated image", default: "" },
    ...
    { name: "seed", type: "number", label: "Seed", default: -1, min: -1, max: 2_147_483_647, description: "-1 for random" },
    { name: "loras", type: "string", label: "LoRAs", description: "Comma-separated LoRA entries: path:strength,... (e.g. detail_enhancer:0.8,style_cartoon:0.6)", default: "" },
  ],
  build(params) {
