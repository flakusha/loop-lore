...
export const controlnet: WorkflowTemplate = {
  ...
  parameters: [
    ...
    { name: "controlnet_strength", type: "number", label: "ControlNet Strength", default: 1, min: 0, max: 2, step: 0.1 },
  ...
  build(params) {
    ...
    return {
      ...
      ...loadImageNode("5", "control_image", params, "Load Control Image"),
      "6": {
        inputs: { control_net_name: (params.controlnet_model as string) ?? "control_v11p_sd15_canny" },
        class_type: "ControlNetLoader",
        _meta: { title: "Load ControlNet" },
      },
      "7": {
        inputs: {
          strength: (params.controlnet_strength as number) ?? 1,
          condition: ["2", 0],
          control_net: ["6", 0],
          image: ["5", 0],
        },
      ...
      ...decodeAndSave("8", ["1", 2], "loop-lore-controlnet"),
    };
  },
};
