...
describe("story/quests/calculators/destruction (0% -> real logic)", () => {
  ...
  it("returns 0 for non-combat events", () => {
    ...
    expect(calculateDestructionProgress(null as any, { targetQuantity: 5, }, event as any,),).toBe(0,);
  });
  ...
  it("returns 1 when targeted actor is defeated", () => {
    ...
    expect(calculateDestructionProgress(null as any, { targetQuantity: 5, targetActorId: "e1", }, event as any,),).toBe(
      1,
    );
  });
  ...
  it("returns percentage progress when no target actor", () => {
    ...
    expect(calculateDestructionProgress(null as any, { targetQuantity: 4, }, event as any,),).toBe(25,);
  });
});
