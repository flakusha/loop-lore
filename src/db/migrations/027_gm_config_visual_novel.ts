...
/**
 * Migration 027 — GM Config, Visual Novel, Streaming
 *
 * Adds:
 * - `visual_novel` column to chats table
 * - `streaming` column to chats table (true/false/null for per-chat streaming mode)
 *
