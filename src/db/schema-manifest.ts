...
export const SCHEMA = new SchemaManifest()
  ...
  .table("interaction_logs", {
    ...
    world_id: col("text",),
    actor_id: col("text", { notNull: true, },),
    target_actor_id: col("text",),
    location_id: col("text",),
    command: col("text", { notNull: true, },),
    category: col("text", { notNull: true, },),
    skill: col("text", { notNull: true, },),
    difficulty: col("integer", { notNull: true, },),
    roll_sides: col("integer",),
    roll_count: col("integer",),
    roll_modifier: col("integer",),
    roll_mode: col("text",),
    roll_values: col("text",),
    roll_raw_total: col("integer",),
    roll_total: col("integer",),
    roll_margin: col("integer",),
    outcome: col("text", { notNull: true, },),
    action_points: col("integer", { notNull: true, hasDefault: true, },),
