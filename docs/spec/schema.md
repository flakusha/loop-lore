...
| 020 | `020_workflow_sessions.ts`          | Workflow session persistence + mesh tables (021 skipped per `020_workflow_sessions.ts` comment)                                                                                                                                                                                                                                                                                                              |
| 022 | `022_mesh_sharing.ts`               | Mesh sharing tables for federation gossip/sharing/fan-out                                                                                                                                                                                                                                                                                                                                                  |
All parts in `001_init.ts` are kept at pre-008 state. Migrations 008-017 add
columns incrementally; migrations 018-022 add workflow + federation mesh.
