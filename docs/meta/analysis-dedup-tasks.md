...
_Analysis based on `docs/meta/review-topics.md` (2026-07-27), `.plan/cross-mechanics-integration-matrix.md` (2026-07-27), `.plan/backlog.md`, `.plan/immediate.md`, `.plan/epics.md`, and directory traversal of `docs/` and `.plan/`._
