...
| Local inference (ComfyUI, llama-swap, sd.cpp)               | docs/research/comfyui-local-inference.md + docs/research/local-remote-inference-uis.md | Full spec in source research docs        |
