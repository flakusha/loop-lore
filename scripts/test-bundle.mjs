...
try {
  ...
  try {
    console.log("  sidebar store:", !!globalThis.Alpine.store("sidebar",),);
  } catch (error) {
    console.log("  sidebar ERR:", error.message,);
  }
  try {
    console.log("  chat store:", !!globalThis.Alpine.store("chat",),);
  } catch (error) {
    console.log("  chat ERR:", error.message,);
  }
  try {
    console.log("  ui store:", !!globalThis.Alpine.store("ui",),);
  } catch (error) {
    console.log("  ui ERR:", error.message,);
  }
} catch (error) {
  console.log("✗ vendor.js FAILED:", error.message,);
}
