...
Acceptance:
- [ ] runAutoRotation on a standard-tier chat produces zero decryption failures
- [ ] actor keys still expire/rotate on schedule
- [ ] unit test asserting no re-encrypt attempts against chat_keys-keyed messages
