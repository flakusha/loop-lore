...
- [OK] Abort wired through generation streaming path (fixes never-wired BUG)
- [OK] Truncate-to-last-rendered-chunk semantics; user input free immediately
- [OK] Queued TTS/image jobs cancelled cleanly
- [OK] Usage/billing hooks respect delivery
- [OK] Tests: mid-stream stop + no-bill assertion
