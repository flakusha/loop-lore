...
Replace the current "collect then resume" pattern in `executeToolCalls` (`src/generation/generate-route/tool-execution.ts:47`, `MAX_TOOL_ROUNDS=5`) with progressive emission:
