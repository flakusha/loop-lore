...
Core single-axis happiness meter: mood state, triggers/effects, and expression modifiers. Mood modifies HOW personality is expressed, NOT WHAT personality is. Integrates with relationships, world context, and avatar selection.
...
- Siblings: TASK-mood-multi-dimensional and TASK-mood-contagion **extend this core** — land after it.
- Related: TASK-character-personality-integrity.md, TASK-character-relationships.md, TASK-character-world-data-separation.md, TASK-emotions-avatar-edit-model.md, epic-emotion-avatar-message-binding.md, TASK-emotion-avatar-message-binding.md, epic-character-core-system.md
