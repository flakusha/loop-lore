...
- [ ] Shadow note data model (type, content, visibility, trigger condition, revealed state)
...
- [ ] Shadow note types: foreshadowing, consequence, hidden_fact, player_motivation, world_secret, narrative_hook
...
- [ ] Frontend GM shadow note panel (add/edit/remove/reveal shadow notes)
