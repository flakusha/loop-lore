...
| --- | --------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A1  | NSFW audit-log UI + consent display                                         | P0 partial (`immediate.md` L37, L70)                                                                                                            | ▲ done    | ▲ **Finalized shipped 2026-08-06** — audit-log UI + consent display (FeatNSFWAuditUI); runtime config + live enforcement already shipped 2026-08-03                  |
...
| B2  | Chat message search & filter                                                | `TASK-chat-message-search.md` (P2-B/P4/P5)                                                                                                      | ▲ done    | ▲ **Finalized shipped 2026-08-06** — in-chat message search + filter with highlight (FeatMsgSearch)                                                                  |
| B3  | Chat transfer + location change                                             | `TASK-chat-transfer-location.md` (P2-B/P4)                                                                                                      | ▲ done    | ▲ **Finalized shipped 2026-08-06** — chat transfer + location-change UI panel, VN transition on location change (FeatTransferUI)                                     |
| B4  | Stop generation (chat+VN)                                                   | P5                                                                                                                                              | ▲ done    | ▲ **Finalized shipped 2026-08-06** — chat stop already on dev (AbortController + `/api/generation/cancel`); added VN in-scene stop overlay (FeatStopGen)             |
| B5  | Notification center + noise filtering                                       | P5                                                                                                                                              | ▲ done    | ▲ **Finalized shipped 2026-08-06** — standalone notification center view + per-type mute/noise filtering (FeatNotifCenter)                                           |
| B6  | IO export/import (PNG/YAML/TOML/CHARX; world/loc/story)                     | P4/P5                                                                                                                                           | ▲ done    | ▲ **Finalized shipped 2026-08-06** — export/import IO (FeatIOExport)                                                                                                 |
...
| B9  | i18n frontend strings + locale switcher                                     | `backlog.md` L68                                                                                                                                | ▲ done    | ▲ **Finalized shipped 2026-08-06** — locale switcher fixes `ll_locale` cookie root cause + frontend i18n keys across 10 locales (FeatI18nUI)                         |
...
| --------- | ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| **P2-A**  | **Visual Novel Mode**                | [`TASK-visual-novel-mode.md`](tickets/TASK-visual-novel-mode.md), [`TASK-chat-visual-novel-mode.md`](tickets/TASK-chat-visual-novel-mode.md), [`TASK-vn-branching-choices.md`](tickets/TASK-vn-branching-choices.md), [`TASK-vn-dynamic-generation.md`](tickets/TASK-vn-dynamic-generation.md), [`TASK-vn-qa-mode.md`](tickets/TASK-vn-qa-mode.md), [`TASK-vn-scene-template-system.md`](tickets/TASK-vn-scene-template-system.md), [`TASK-vn-template-actions.md`](tickets/TASK-vn-template-actions.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | 🟡 Foundation done                                                          |
| **P2-G**  | **LoRA Discovery & Application**     | [`TASK-lora-discovery-application.md`](tickets/TASK-lora-discovery-application.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | ⬜ Not Started                                                              |
| **P2-B**  | **Chat System**                      | [`TASK-chat-autorenaming.md`](tickets/TASK-chat-autorenaming.md), [`TASK-chat-backgrounds-location-sync.md`](tickets/TASK-chat-backgrounds-location-sync.md), [`TASK-chat-external-music-linking.md`](tickets/TASK-chat-external-music-linking.md), [`TASK-chat-room-search-join.md`](tickets/TASK-chat-room-search-join.md), [`TASK-chat-room-filters.md`](tickets/TASK-chat-room-filters.md), [`TASK-chat-message-search.md`](tickets/TASK-chat-message-search.md), [`TASK-chat-sectioning-multi-location.md`](tickets/TASK-chat-sectioning-multi-location.md), [`TASK-chat-transfer-location.md`](tickets/TASK-chat-transfer-location.md), [`TASK-travel-party-migration.md`](tickets/TASK-travel-party-migration.md), [`TASK-transition-aux-llm-fallback.md`](tickets/TASK-transition-aux-llm-fallback.md), [`TASK-aux-mood-classification.md`](tickets/TASK-aux-mood-classification.md), [`TASK-aux-memory-extraction.md`](tickets/TASK-aux-memory-extraction.md), [`TASK-aux-environment-interaction.md`](tickets/TASK-aux-environment-interaction.md), [`TASK-aux-personality-drift.md`](tickets/TASK-aux-personality-drift.md), [`TASK-aux-gm-tool-detection.md`](tickets/TASK-aux-gm-tool-detection.md), [`TASK-aux-scene-context.md`](tickets/TASK-aux-scene-context.md), [`TASK-aux-emotion-avatar.md`](tickets/TASK-aux-emotion-avatar.md), [`tickets/TEST-invite-join-e2e.md`](tickets/TEST-invite-join-e2e.md), [`tickets/TASK-invite-code-generation.md`](tickets/TASK-invite-code-generation.md), [`tickets/TASK-join-flow-mechanics.md`](tickets/TASK-join-flow-mechanics.md), [`epics/epic-world-chat-channels-invites.md`](epics/epic-world-chat-channels-invites.md) | 🟡 In Progress (invites, sections, backgrounds, filters shipped 2026-08-03) |
| **P2-C**  | **Assistant & Tool Calling**         | [`TASK-assistant-commands-extension.md`](tickets/TASK-assistant-commands-extension.md), [`TASK-assistant-command-execution-intent-detection.md`](tickets/TASK-assistant-command-execution-intent-detection.md), [`TASK-assistant-gm-flows.md`](tickets/TASK-assistant-gm-flows.md), [`TASK-assistant-gm-flows-reconciliation.md`](tickets/TASK-assistant-gm-flows-reconciliation.md), [`TASK-wire-gm-service-story-mode.md`](tickets/TASK-wire-gm-service-story-mode.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | 🟡 Command buttons expanded                                                 |
| **P2-D**  | **GM Flows**                         | [`TASK-assistant-gm-flows.md`](tickets/TASK-assistant-gm-flows.md), [`TASK-gm-shadow-notes.md`](tickets/TASK-gm-shadow-notes.md), [`TASK-gm-whitenotes.md`](tickets/TASK-gm-whitenotes.md), [`TASK-assistant-gm-flows-reconciliation.md`](tickets/TASK-assistant-gm-flows-reconciliation.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | 🟡 Frontend done, backend pending                                           |
| **P2-Da** | **GM-Guided Story Creation** _(NEW)_ | [TASK-gm-guided-story-creation.md](tickets/TASK-gm-guided-story-creation.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | ⬜ Not Started                                                              |
| **P2-E**  | **Authorization & Access**           | [`TASK-auth-register-route.md`](tickets/TASK-auth-register-route.md), [`TASK-two-factor-multi-factor-auth.md`](tickets/TASK-two-factor-multi-factor-auth.md), [`TASK-encryption-access-management.md`](tickets/TASK-encryption-access-management.md), [`TASK-dedupe-message-access-checks.md`](tickets/TASK-dedupe-message-access-checks.md), [`TASK-fix-message-reactions-access.md`](tickets/TASK-fix-message-reactions-access.md), [`TASK-authoring-creation.md`](tickets/TASK-authoring-creation.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | ⬜ Not Started                                                              |
| **P2-F**  | **Gallery**                          | [`TASK-gallery-minimal-image-asset-viewer.md`](tickets/TASK-gallery-minimal-image-asset-viewer.md), [`TASK-config-gallery-attachment-idempotent.md`](tickets/TASK-config-gallery-attachment-idempotent.md), [`TASK-character-avatar-gallery-binding.md`](tickets/TASK-character-avatar-gallery-binding.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | 🟡 In Progress (avatar binding backend done)                                |
...
- [x] Implement chat message search & filter (`TASK-chat-message-search.md`) — FTS migration + in-chat search w/ highlight (2026-08-06, FeatMsgSearch)
...
- [x] Implement chat transfer + location change (`TASK-chat-transfer-location.md`) — location panel + transfer + VN transition (2026-08-06, FeatTransferUI)
...
| Tool calling display          | Persisted `tool_result` rows render as collapsible blocks in chat (`src/components/chat/message-list.html:182-188`); row insertion via `persistToolResults` in `src/generation/generate-route/tool-execution.ts` | ✅ Partial — persisted tool calls/results visible in chat; richer function-call + params bubble UI open                                         |
...
- [x] Implement assistant tool calling display — persisted `tool_result` rows render as collapsible blocks in chat — 2026-09-15
- [ ] Richer function-call + params bubble UI (beyond collapsible tool-result blocks)
...
**Ticket**: [`TASK-gm-guided-story-creation.md`](tickets/TASK-gm-guided-story-creation.md)
...
| -------- | ----------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **P3**   | **Plugin Ecosystem**    | Plugin management API, marketplace, sandboxing | ⬜ Not Started                                                                             | [`TASK-plugin-system.md`](tickets/TASK-plugin-system.md), [`TASK-plugin-management-api.md`](tickets/TASK-plugin-management-api.md), [`TASK-plugin-api-system.md`](tickets/TASK-plugin-api-system.md) |
...
| **P3**   | **Artifact System**     | Code/docs/datasets as assets                   | ⬜ Not Started                                                                             | [`TASK-artifact-system.md`](tickets/TASK-artifact-system.md)                                                                                                                         |
| **P3**   | **ComfyUI Integration** | Node discovery, workflow templates             | ⬜ Not Started                                                                             | [`TASK-comfyui-node-discovery.md`](tickets/TASK-comfyui-node-discovery.md), [`FEAT-comfyui-plugin-workflow-templates.md`](FEAT-comfyui-plugin-workflow-templates.md)                 |
...
| 5  | **Chats — all 9 types**                                                                            | 🟡 P2-B in progress        | autorenaming ✅, sections ✅, invites ✅, filters ✅, message search ✅, transfer/location ✅ (2026-08-06)                                                                                                                                          |
| 6  | **NSFW features, prompting, opt-in, sfw/nsfw caps**                                                | 🟢 core / 🟡 UI            | runtime config + live enforcement ✅; audit-log UI + consent display ✅ (2026-08-06); character 5-tier rating UI open                                                                                                                               |
| 7  | **Metadata extraction + captioning**                                                               | 🟢 done                    | regex pipeline ✅; caption-route wired `8f8c0abb`                                                                                                                                                                                                   |
| 8  | **i18n**                                                                                           | 🟢 done                    | `ctx.t` + 11 locales ✅; frontend strings + locale switcher ✅ (2026-08-06, `ll_locale` cookie root-cause fix, FeatI18nUI)                                                                                                                          |
...
| —  | **IO: import/export** — characters, worlds, locations, stories                                     | 🟡 partial                 | JSON character import ✅; PNG/YAML/TOML/CHARX + world/location/story export ✅ (2026-08-06, FeatIOExport)                                                                                                                                           |
| —  | **Stop generation** for chat/VN                                                                    | 🟢 shipped                 | chat abort/cancel on dev; VN in-scene stop overlay added (2026-08-06, FeatStopGen)                                                                                                                                                                  |
| —  | **Notifications + notification center**                                                            | 🟢 shipped                 | cross-chat SSE + unread badge ✅; center UI + per-type mute/noise filtering ✅ (2026-08-06, FeatNotifCenter)                                                                                                                                        |
| —  | **Filtering & search tools** — chats, gallery, worlds, locations                                   | 🟡 partial                 | chat room filters ✅ (2026-08-05); chat message search ✅ (2026-08-06); world/location search pending                                                                                                                                               |
...
- [x] Chats: group chat UI, GM panels + quest log, story-mode frontend — chat message search ✅, chat transfer/location change ✅ (both 2026-08-06)
- [x] NSFW: audit-log UI + consent display ✅ (2026-08-06); character NSFW content rating (5-tier) runtime enforcement
...
- [x] IO: story + world/location export; import flow for characters/worlds/locations/stories — PNG/YAML/TOML/CHARX + world/loc/story export ✅ (2026-08-06, FeatIOExport)
- [x] Stop generation: abort/cancel LLM stream UI in chat (on dev) + VN in-scene stop overlay ✅ (2026-08-06); idempotent partial-message handling
- [x] Notification center UI + noise filtering — center view + per-type mute ✅ (2026-08-06, FeatNotifCenter)
- [x] Filtering & search: chat message search w/ highlight ✅ (2026-08-06), world/location search + filters, gallery search polish, combined filters
