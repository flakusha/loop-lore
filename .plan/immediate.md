...
- [ ] **Character avatar gallery binding** — link avatar assets via `asset_links` on creation, add gallery entity filter, character detail gallery tab, visibility inheritance (issue `870cd46`, ticket `TASK-character-avatar-gallery-binding.md`)
- [ ] **Verification**: `bun run check`
