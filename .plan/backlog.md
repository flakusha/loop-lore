...
| **P2-E†**    | **Unify 401 Guard Helpers** _(debt)_ — collapse 3 competing `requireUser`-style helpers + ~5 inline 401 idioms across 26 route files into one canonical localizing guard; frontend-safe (keys on `status: 401` only) | [`TASK-unify-401-guard-helpers.md`](TASK-unify-401-guard-helpers.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 🟡 In Progress (Sentinel) |
