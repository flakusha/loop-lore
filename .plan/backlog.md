...
| Feature                                                                 | Spec                                                                    | Notes                                                                                                              |
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| RAG & Document Processing (Enterprise Knowledge Management)             | `epic-rag-document-processing.md`                                       | Ingestion, embedding, vector search, context injection, compliance                                                 |
| Communications Integrations (Matrix, XMPP, IM, Email)                   | `epic-communications-integrations.md`                                   | Federation, E2EE, bridges, notifications                                                                           |
| Social Hub (Messengers, Social Networks, Email Modernization)           | `epic-social-hub.md`                                                    | Cross-platform adapters, email alternatives (Nostr, AT Protocol), bridging                                         |
| Anonymity & Decentralization (Tor, I2P, Mesh, BYOK)                     | `epic-anonymity-decentralization.md`                                    | Anonymous access, distributed infra, P2P resource sharing                                                          |
| Security & Sandboxing (LLM, Testing, Escape Prevention)                 | `epic-security-sandboxing.md`                                           | LLM sandboxing, prompt injection defense, automated security testing                                               |
| API Governance (OpenAPI, Validation, Rate Limiting, Telemetry)          | `epic-api-governance.md`                                                | OpenAPI spec, request validation, rate limiting, metrics, resource offloading                                      |
