...
| #  | Item                                                                                                                                                              | Where                                                          | Status                                   |
| -- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ---------------------------------------- |
| 1  | Entire transport module (~9 files) unwired                                                                                                                        | `src/transport/`                                               | 🟡 Remove or wire into `server.ts`       |
...
| 12 | RPG services unwired from production (Skills, Quest, Recipes, Achievements, NpcNavigation, Replayability, WorldLocationTraits) + combat/loot/xp no prod consumers | `src/rpg/*/service.ts`                                         | 🟡 Wire or remove                        |
| 13 | Dual quest system (`rpg/quests` vs `story/quest-engine`)                                                                                                          | divergence                                                     | 🟡 Consolidate                           |
| 14 | `profanity.containsProfanity` dead; `admin.getUnhealthyProviders` dead                                                                                            | services                                                       | 🟡 Remove or wire                        |
