...
> **Last updated:** 2026-08-13. Consolidated from `open.md` + `active.md` into this single
...
| --- | --------------------------------------------------------------------------------------- | -------------------------------------------- | ------------------------------- | --------------------- |
| A5  | Lint-ts debt (291 files) → `check` 16/17 — **last red gate**                            | `../priority.md` "Open → close"              | ▲ now (release-blocking)        |                       |
...
| 2  | Telemetry `startRetentionCleanup` never called                                                                                                                     | `src/telemetry/cleanup.ts:12`                                  | 🟡 Open                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| 7 | `age-gate/controller.ts` error message leak                                                  | `src/age-gate/controller.ts:91,126`                   | 🟡 Open                                                                                            |
