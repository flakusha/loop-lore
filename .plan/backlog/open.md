...
| A9  | Release artifacts (release-process, tag `v0.1.0`, changelog) + push `dev`→`origin/dev`  | `../priority.md` "Open → close"              | ▲ now                           | 🟡 artifacts done 2026-08-15 (`docs/meta/release-process.md`, `CHANGELOG.md`, signed tag `v0.1.0` @ ed2c6c5c) — **push pending: pre-push hook blocks agent, human must push** (93 commits ahead) |
