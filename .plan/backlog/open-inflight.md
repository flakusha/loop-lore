...
| C1  | Chat-type matrix UI remainder (group-chat UI, unified GM↔assistant view)               | `../priority-p0-p2.md`                        | ▲ now                           | 🟡 partial (participant panel shipped 2026-08-14 — list/add/remove + talkativity/initiative; turn-order indicator + side-channels remain) |
...
| C5  | LLM providers (Anthropic/Ollama/Bedrock)                                               | `../priority-p3-p5.md`                          | ▲ now                           |                       |
...
| F3  | M6 AUX telemetry (tokens/latency per call)                                              | `../priority-release-010.md`                   | ▲ now                           |                       |
