...
| W5  | **Chat frontend wiring + search + navigation** — WT1 (pins/location/transfer/archive/response-length/route-extract) + WT2 (FTS5 message search + room filters) + WT3 (section navigation + VN wiring + state tests) | `TASK-chat-pins-frontend.md`, `TASK-chat-message-search.md`, `TASK-chat-room-filters.md`, `TASK-chat-flow-section-navigation.md`, `TASK-chat-visual-novel-mode.md` | ▲ now | ✅ **DONE 2026-08-18** — pins, response-length, FTS5 message search (`message-search/` + migration `034`), section navigation + VN mode shipped (`1385943e`, `36f24792`, `be3d6dfd`) |
