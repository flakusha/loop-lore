...
---
*Notes: Extends existing `src/memory/` and `src/story/timeline/` infrastructure. Leverages migration `030_world_timeline_events.ts` for event storage. Does NOT define memory tiers — that's Memory & Knowledge's domain.*
