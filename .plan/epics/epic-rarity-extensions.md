...
---
*Notes: Builds upon existing `src/items/rarity.ts` and `docs/spec/items.md` rarity table. Timeline-weighted rarity is additive to base rarity. This is the terminal epic in the chain — no epics depend on this.*
