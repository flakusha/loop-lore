...
---
*Notes: Builds upon migration `030_world_timeline_events.ts` and service `src/story/timeline/world-timeline.ts`. Timeline selection UI reuses existing world detail page patterns. This is the foundational epic — all other timeline-aware epics depend on this.*
