...
---
*Notes: Builds upon existing lorebook system in `src/assistant/lore/` and `src/routes/actor-lore-entries.ts`. Secret lore UI reuses world detail page patterns. Reads `timeline_id` from Timeline System epic (indirect dependency).*
