...
| 🟡 Partial — character API + validation + personality/traits implemented; RPG stat system + template system in progress | Character Core System | High | High | 3 | [epic-character-core-system.md](/.plan/epics/epic-character-core-system.md) |
...
| 🟡 Partial (budget, extraction, injection, provision, purge, shareability built) | Epic: Memory & Knowledge Systems | High | High | 4 | [epic-memory-knowledge-systems.md](/.plan/epics/epic-memory-knowledge-systems.md) |
